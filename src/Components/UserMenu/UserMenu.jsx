...
import AccountDashboardModal from '../Modals/AccountDashboardModal/AccountDashboardModal'
...
const UserMenu = () => {
    ...
    const handleAccountDashBoardPopup = () => {
        setTouched(true);
    }
    ...
    return (
        <div className={styles.userMenuContainer}>
            ...
            <div className={styles.profileContainer} onClick={handleAccountDashBoardPopup}>
                <figure>
